...
/*
special keys
let spaceKD = new Audio("audio/topre/topre_space.mp3");
let enterKD = new Audio("audio/topre/topre_enter.mp3");
let backspaceKD = new Audio("audio/topre/topre_backspace.mp3");
*/

// audio elements on pressed 
// TOPRE
let row1KD = new Audio("audio/topre/topre_R1.mp3");
let row2KD = new Audio("audio/topre/topre_R2.mp3");
let row3KD = new Audio("audio/topre/topre_R3.mp3");
let spaceKD = new Audio("audio/topre/topre_space.mp3");
let enterKD = new Audio("audio/topre/topre_enter.mp3");
let backspaceKD = new Audio("audio/topre/topre_backspace.mp3");
...
// TOPRE
let rowKU = new Audio("audio/topre/topre_release.mp3");
let spaceKU = new Audio("audio/topre/topre_release_space.mp3");
let enterKU = new Audio("audio/topre/topre_release_enter.mp3");
let backspaceKU = new Audio("audio/topre/topre_release_backspace.mp3");
